// ==UserScript==
// @name         GeoStudio PBG Controller V13.2 (Complete)
...
(function () {
  ...
  if (IS_MAIN) {
    ...
    const heartbeatChannel = new BroadcastChannel('ps_heartbeat_channel');
    ...
    setTimeout(() => {
      ...
      console.log('✅ GeoStudio PBG Controller V13.2 loaded (Main Window)');
    }, 1000);
  ...
  if (IS_IFRAME) {
    ...
    (async function initIframe() {
      ...
      console.log('✅ GeoStudio PBG Controller V13.2 loaded (Iframe)');
    })();
